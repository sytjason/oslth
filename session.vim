...
map ,tn :tabnew
noremap ,jd :tab YcmCompleter GoToDefinitionElseDeclaration
noremap ,sd :YcmCompleter GoToDefinitionElseDeclaration
...
silent only
silent tabonly
cd ~/Documents/os/OS2019/project1
...
silent! normal! zE
let s:l = 71 - ((11 * winheight(0) + 18) / 37)
...
normal! 014|
tabnext
edit ~/Documents/os/OS2019/project1/vscheduler.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 189 - ((28 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
189
...
normal! 0
tabnext
edit ~/Documents/os/OS2019/project1/vscheduler.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((0 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
set stal=1
badd +0 main.c
badd +0 ~/Documents/os/OS2019/project1/vscheduler.h
badd +0 ~/Documents/os/OS2019/project1/vscheduler.c
badd +0 queue.c
badd +0 queue.h
